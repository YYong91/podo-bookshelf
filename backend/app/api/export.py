...
async def export_all(
    ...
    books_result = await db.execute(select(Book).where(Book.is_deleted is False))
    books = []
    ...
    reviews_result = await db.execute(select(Review).where(Review.is_deleted is False))
    reviews = []
