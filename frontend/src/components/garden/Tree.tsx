...
export default function Tree({ bunchCount }: TreeProps) {
  ...
  return (
    <svg viewBox="0 0 110 180" className="h-full w-full">
      <defs>
        <linearGradient id={`${uid}-t-trunk`} x1="0" y1="0" x2="1" y2="0">
        ...
        <radialGradient id={`${uid}-t-leaf-light`} cx="40%" cy="35%" r="60%">
          <stop offset="0%" stopColor="#8ED88E" />
          <stop offset="100%" stopColor="#4CAF4C" />
        </radialGradient>
        <radialGradient id={`${uid}-t-leaf-mid`} cx="45%" cy="40%" r="55%">
          <stop offset="0%" stopColor="#6BC46B" />
          <stop offset="100%" stopColor="#3D923D" />
        </radialGradient>
        <radialGradient id={`${uid}-t-leaf-dark`} cx="50%" cy="45%" r="55%">
          <stop offset="0%" stopColor="#4CAF4C" />
          <stop offset="100%" stopColor="#2D7A2D" />
        </radialGradient>
        <radialGradient id={`${uid}-t-grape-f`} cx="35%" cy="35%" r="65%">
          <stop offset="0%" stopColor="#C4A0F8" />
          <stop offset="100%" stopColor="#7C3AED" />
        </radialGradient>
        <radialGradient id={`${uid}-t-grape-e`} cx="35%" cy="35%" r="65%">
      ...
      {/* 뒤쪽 잎 레이어 (어두운) */}
      <ellipse cx={55} cy={52} rx={48} ry={42} fill={`url(#${uid}-t-leaf-dark)`} opacity="0.3" />
      <circle cx={22} cy={56} r={20} fill={`url(#${uid}-t-leaf-dark)`} opacity="0.35" />
      <circle cx={88} cy={54} r={19} fill={`url(#${uid}-t-leaf-dark)`} opacity="0.35" />
      <circle cx={55} cy={28} r={18} fill={`url(#${uid}-t-leaf-dark)`} opacity="0.3" />

      {/* 중간 잎 레이어 */}
      <circle cx={35} cy={42} r={22} fill={`url(#${uid}-t-leaf-mid)`} opacity="0.55" />
      <circle cx={75} cy={40} r={21} fill={`url(#${uid}-t-leaf-mid)`} opacity="0.55" />
      <circle cx={55} cy={35} r={24} fill={`url(#${uid}-t-leaf-mid)`} opacity="0.45" />
      <circle cx={18} cy={62} r={16} fill={`url(#${uid}-t-leaf-mid)`} opacity="0.45" />
      <circle cx={92} cy={60} r={15} fill={`url(#${uid}-t-leaf-mid)`} opacity="0.45" />

      {/* 앞쪽 잎 레이어 (밝은) */}
      <circle cx={30} cy={52} r={18} fill={`url(#${uid}-t-leaf-light)`} opacity="0.5" />
      <circle cx={55} cy={45} r={20} fill={`url(#${uid}-t-leaf-light)`} opacity="0.4" />
      <circle cx={80} cy={50} r={17} fill={`url(#${uid}-t-leaf-light)`} opacity="0.5" />
      <circle cx={42} cy={70} r={15} fill={`url(#${uid}-t-leaf-light)`} opacity="0.45" />
      <circle cx={68} cy={68} r={16} fill={`url(#${uid}-t-leaf-light)`} opacity="0.45" />
      <circle cx={55} cy={22} r={14} fill={`url(#${uid}-t-leaf-light)`} opacity="0.35" />
      ...
      {bunchPositions.map((pos, i) => {
        ...
        const gf = filled ? `url(#${uid}-t-grape-f)` : `url(#${uid}-t-grape-e)`;
        return (
